...
func (o *ServerOptions) Validate() []error {
	...
	if o.Address <= 0 || o.Address > 65535 {
	...
	if o.CtlPort <= 0 || o.CtlPort > 65535 {
		errs = append(errs, errors.New("Invalid ctl port. Must be within the range of 1-65535"))
	}

	// 验证 ConfigPath 字段是否为空
	if o.ConfigPath == "" {
		errs = append(errs, errors.New("Config path is required"))
	}
